...
load_theme_textdomain( 'shb', get_template_directory() . '/languages' );
...
require_once( trailingslashit( get_template_directory() ). '/7upframe/controler/walker_product_cat_list.php' );
