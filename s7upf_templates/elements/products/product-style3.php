                    ...
                    <div class="product-thumb">
                        ...
                        <div class="product-extra-link">
                            <?php
                                ...
                                s7up_wishlist_url(esc_html__('Wishlist','shb'));
                                s7upf_compare_url(false,esc_html__('Compare','shb'));
                            ?>
                        </div>
                    </div>
                </div>
...
if(!empty($data_banner_3) and is_array($data_banner_3)){
    foreach ($data_banner_3 as $key=>$value) {
        ...
        array_splice($array_product, $position, 0, $banner_html);
    }
}
    ...
    <div class="content-product-box4 woocommerce">
        <div class="row">
            <?php foreach ($array_product as $key=>$value){
                ...
                if($i % 9 == 0 ||$i % 9 == 1 || $i % 9 == 2 || $i % 9 == 3 || $i % 9 == 4 || $i % 9 == 7|| $i % 9 == 6|| $i % 9 == 9)
                echo'</div>';
                $i++;
            }?>
