...
if ( $upsells and  'on' === $show_sells) : ?>
    <div class="related-product product-up-sells <?php if(empty($title_sells)) echo'no-title'; ?>">
        <?php if(!empty($title_sells)){ ?>
            <h2 class="title14 text-center"><span><?php echo esc_attr($title_sells); ?></span></h2>
        <?php } ?>
        <div class="product-related-slider">
            <div class="wrap-item" data-navigation="true" data-pagination="false" data-itemscustom="[[0,1],[480,2],[768,3],[990,<?php echo esc_attr($itemscustom); ?>]]">
                <?php foreach ( $upsells as $upsell ) :
                    ...
                    $units_sold = get_post_meta( $upsell->get_id(), 'total_sales', true );
                    ...
                    <div class="item-product item-product-grid">
                        <div class="product-thumb box-hover-dir">
                            ...
                            if ( $upsell->is_on_sale()) : ?>

                                <?php echo apply_filters( 'woocommerce_sale_flash', '<span class="product-sale-label">' . esc_html__( 'Sale!', 'shb' ) . '</span>', $upsell, $upsell ); ?>
                        ...
                        <div class="product-info">
                            ...
                            <div class="product-price">
                                ...
                                if(!empty($discount_sale) and $upsell->is_on_sale()) {?>
